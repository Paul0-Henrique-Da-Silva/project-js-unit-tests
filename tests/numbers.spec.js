...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
  ...
  it('verificar a entrada de array [1, 2, 3, 4, 5] retorna true', () => {
    expect(numbers([1, 2, 3, 4, 5])).toBeTruthy()
  });
  it('verificar a entrada de array [1, 2, "3", 4, 5] retorna false', () => {
    expect(numbers([1, 2, '3', 4, 5])).toBeFalsy()
  });
  it('verificar a entrada de array [1, "a", 3] e retorna false', () => {
    expect(numbers([1, 'a', 3])).toBeFalsy()
  });
  it('verificar a entrada de array [" "] e retorna false', () => {
